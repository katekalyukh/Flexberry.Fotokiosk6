...
moduleForAcceptance('[AGAT] Acceptance | i i s fotokiosk6 печать фото l');

test('testing i-i-s-fotokiosk6-печать-фото-l', function(assert) {
  visit('/i-i-s-fotokiosk6-печать-фото-l');
