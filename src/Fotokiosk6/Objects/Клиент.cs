...
namespace IIS.Fotokiosk6
{
    ...
    public class Клиент : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Fotokiosk6.ОтправНаПочту fОтправНаПочту;
        
        private IIS.Fotokiosk6.Оплата fОплата;
        ...
        [PropertyStorage(new string[] {
                "Оплата"})]
        [NotNull()]
        public virtual IIS.Fotokiosk6.Оплата Оплата
        {
            get
            {
                ...
                IIS.Fotokiosk6.Оплата result = this.fОплата;
        ...
        [PropertyStorage(new string[] {
                "ОтправНаПочту"})]
        [NotNull()]
        public virtual IIS.Fotokiosk6.ОтправНаПочту ОтправНаПочту
        {
            get
            {
                ...
                IIS.Fotokiosk6.ОтправНаПочту result = this.fОтправНаПочту;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КлиентE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КлиентE", typeof(IIS.Fotokiosk6.Клиент));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КлиентL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КлиентL", typeof(IIS.Fotokiosk6.Клиент));
                }
            }
        }
    }
