...
namespace IIS.Fotokiosk6
{
    ...
    public class Оплата : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Fotokiosk6.ВидОплаты fСпособОпл;
        ...
        public virtual IIS.Fotokiosk6.ВидОплаты СпособОпл
        {
            get
            {
                ...
                IIS.Fotokiosk6.ВидОплаты result = this.fСпособОпл;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ОплатаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОплатаE", typeof(IIS.Fotokiosk6.Оплата));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ОплатаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОплатаL", typeof(IIS.Fotokiosk6.Оплата));
                }
            }
        }
    }
